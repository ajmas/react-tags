...
var ReactTags = (function (superclass) {
  ...
  ReactTags.prototype.escapeForRegExp = function escapeForRegExp (query) {
  ...
  ReactTags.prototype.handlePaste = function handlePaste (e) {
    var this$1 = this;
    ...
    var ref = this.props;
    var delimiterChars = ref.delimiterChars;
    ...
    if (data && delimiterChars.length > 0) {
      ...
      var tags = data.split(new RegExp('[' + this.escapeForRegExp(delimiterChars.join('')) + ']'))
      var loop = function ( i ) {
        ...
        if (tags[i].length > 0) {
          ...
          var matchIdx = this$1.props.suggestions.findIndex(function (suggestion) {
            return tags[i] === suggestion.name
          })

          // if already known add it, otherwise add it only if we allow new tags
          if (matchIdx > -1) {
            this$1.addTag(this$1.props.suggestions[matchIdx])
          } else if (this$1.props.allowNew) {
            this$1.addTag({ name: tags[i] })
          }
        }
      };

      for (var i = 0; i < tags.length; i++) loop( i );
    ...
    return (
      React.createElement( 'div', { className: classNames.join(' '), onClick: this.handleClick.bind(this) },
        ...
        React.createElement( 'div', {
          className: this.state.classNames.search, onBlur: this.handleBlur.bind(this), onFocus: this.handleFocus.bind(this), onChange: this.handleChange.bind(this), onKeyDown: this.handleKeyDown.bind(this), onPaste: this.handlePaste.bind(this) },
